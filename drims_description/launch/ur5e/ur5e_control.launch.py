...
def launch_setup(context, *args, **kwargs):
  ...
  controllers_config = PathJoinSubstitution([FindPackageShare("drims_description"),
  ...
  robotiq_hande_urcap_launch_path = PathJoinSubstitution([FindPackageShare("drims_description"), "launch", "ur5e", "robotiq_hande_urcap_adapter.launch.py"])
